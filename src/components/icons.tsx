...
export function PlayIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className={className} aria-hidden="true">
      ...
      <path d="M10 8.6 15.5 12 10 15.4V8.6Z" fill="currentColor" stroke="none" />
    </svg>
  );
}

/* ---------- Astăzi este: row icons ---------- */

export function WeddingRingIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} className={className} aria-hidden="true">
      <circle cx="9" cy="15.5" r="4.5" />
      <circle cx="15" cy="15.5" r="4.5" />
      <path d="M10.3 6 12 3l1.7 3-1.7 3-1.7-3Z" strokeLinejoin="round" />
    </svg>
  );
}

export function MemorialCrossIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" className={className} aria-hidden="true">
      ...
      <line x1="8.7" y1="10.5" x2="15.3" y2="10.5" />
